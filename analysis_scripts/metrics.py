...
parser.add_argument("-c", "--config", type=str, help="Set model configuration: Mean or Median")
...
print(f'Metric | Determ | {args.config} | Diff \n')
print('----------------------------------\n')
...
print(f"  Bias | {swmf.calc_bias():+6.3f} | {mod_tab.calc_bias():+6.3f} |" +
      f" {mod_tab.calc_bias() - swmf.calc_bias():+6.3f}\n\n")
#print(f"  Bias | {swmf.calc_bias():+6.3f} | {mod_tab.calc_bias():+6.3f} |" +
     # f" {b:+6.3f}\n\n")